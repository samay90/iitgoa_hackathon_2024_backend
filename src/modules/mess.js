...
const announcements = ({page}) =>{
    return new Promise((resolve,reject)=>{
        const q = `select a.announcement_id,a.announcement_title,a.user_id,a.announcement_message,a.created_at,a.updated_at,u.name 
        from announcements as a LEFT JOIN users as u on a.user_id=u.user_id  
        where a.is_deleted=0 ORDER BY a.created_at DESC LIMIT 20 OFFSET ${20*(page-1)};`;
